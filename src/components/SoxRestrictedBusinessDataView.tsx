      ...
      <div className="bg-slate-900 border border-purple-500/30 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="space-y-3 flex-1">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Under <strong>Sarbanes-Oxley Act (SOX 404) IT General Controls (ITGC)</strong> and standard corporate governance frameworks, users holding the <strong>Super Administrator (Global IT / Setup)</strong> role are strictly restricted from accessing, inspecting, or operating upon entity-level business and financial data.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 border-t border-slate-800">
          <div className="bg-slate-950/60 rounded-xl p-4 border border-slate-800 space-y-2">
            <div className="flex items-center gap-2 text-xs font-bold text-emerald-400">
              ...
              <span>Super Administrator Scope & Mandate</span>
            </div>
            <p className="text-xs text-slate-400 leading-normal">
              Facilitate global system configuration, tenant entity provisioning, IAM role & user access assignment, AI API key & quota controls, webhook dispatchers, and system backup/disaster recovery.
            </p>
          </div>
          ...
          <div className="bg-slate-950/60 rounded-xl p-4 border border-slate-800 space-y-2">
            <div className="flex items-center gap-2 text-xs font-bold text-rose-400">
              ...
              <span>Segregated Operational Domains</span>
            </div>
            <p className="text-xs text-slate-400 leading-normal">
              General Ledger, Chart of Accounts, Invoices & AR, Vendor Bills & AP, Employee Payroll & Compensation, Financial Reports, Bank Feeds, and AI Audit Copilot ledger queries.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-xs text-slate-400 font-mono">
            Attempted access to view: <strong className="text-slate-200 uppercase">{attemptedTab.replace('_', ' ')}</strong>
          </span>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            >
              <UserCheck className="w-4 h-4" />
              <span>Go to User Provisioning & RBAC</span>
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          >
            ...
            <div>
              <p className="text-xs font-bold text-slate-200 group-hover:text-white">User Provisioning & RBAC</p>
              <p className="text-[10px] text-slate-400">IAM, Scopes & AI Quotas</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <p className="text-xs font-bold text-slate-200 group-hover:text-white">Connectors & Webhooks</p>
              <p className="text-[10px] text-slate-400">Zapier, Make & APIs</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <p className="text-xs font-bold text-slate-200 group-hover:text-white">Backup & Data Restore</p>
              <p className="text-[10px] text-slate-400">Disaster Recovery</p>
            </div>
          </button>
        </div>
      </div>
