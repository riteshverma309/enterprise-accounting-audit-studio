      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            {isMiddleEast && (
              <span className="px-2.5 py-0.5 bg-amber-500/20 text-amber-300 font-mono text-[11px] rounded font-semibold border border-amber-500/30">
                GCC & Middle East Compliant
              </span>
            )}
          </div>
          <p className="text-xs text-slate-400 mt-1">
            Country-specific statutory tax reporting, e-invoicing compliance (ZATCA FATOORA / Dhareeba / EmaraTax), and tax liability schedules.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          >
            ...
            <span>Download Statutory CSV</span>
          </button>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-bold text-white flex items-center gap-2">
                  Saudi Arabia ZATCA Phase 2 FATOORA Integration
                  <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-300 text-[10px] rounded font-mono font-bold">
                    ACTIVE CLEARANCE MODE
                  </span>
                </h2>
                <p className="text-xs text-slate-400">
                  Cryptographic ECDSA secp256k1 stamping, SHA-256 Previous Invoice Hash (PIH) chaining, and Base64 TLV QR Code generation.
                </p>
              </div>
            </div>
            <div className="text-right text-xs font-mono text-slate-400">
              <span className="text-amber-400 font-bold">ZATCA TIN: 300123456700003</span> • CR: 1010892011
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="flex items-center justify-between text-xs text-slate-400">
                <span>Cryptographic Stamp ID (CSID)</span>
                <KeyRound className="w-4 h-4 text-amber-400" />
              </div>
              <div className="text-xs font-mono text-slate-200 truncate">CSID-ZATCA-PROD-904128</div>
              <div className="text-[10px] text-emerald-400 flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3" /> Validated with ZATCA Root CA
              </div>
            </div>

            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="flex items-center justify-between text-xs text-slate-400">
                <span>Hash Chain Integrity (PIH)</span>
                <Layers className="w-4 h-4 text-indigo-400" />
              </div>
              <div className="text-xs font-mono text-slate-200 truncate">NWZkODkyOGExYzllMmE4MTg0N2Q3NGQxNGM3NzA2YzgyMj...</div>
              <div className="text-[10px] text-emerald-400 flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3" /> SHA-256 Chain Sequence Intact
              </div>
            </div>

            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="flex items-center justify-between text-xs text-slate-400">
                <span>Zakat Base & WHT Pool</span>
                <Sparkles className="w-4 h-4 text-purple-400" />
              </div>
              <div className="text-xs font-mono text-slate-200">2.578% Zakat • 5.0% WHT</div>
              <div className="text-[10px] text-indigo-300">
                ERAD Statutory Declaration Ready
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900 rounded-2xl border border-purple-500/30 p-6 space-y-5">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-4 border-b border-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-bold text-white flex items-center gap-2">
                  Qatar GTA Dhareeba Tax Portal E-Filing Engine
                  <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-300 text-[10px] rounded font-mono font-bold">
                    DHAREEBA VERIFIED
                  </span>
                </h2>
            ...
            <div className="text-right text-xs font-mono text-slate-400">
              <span className="text-purple-400 font-bold">Dhareeba TIN: 0000182940</span> • CR: 84920
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="text-xs text-slate-400">Corporate Income Tax (CIT)</div>
              <div className="text-sm font-bold text-white">10.0% on Foreign Shareholding</div>
              <div className="text-[10px] text-emerald-400 flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3" /> Law No. 24/2018 Statutory Schedule
              </div>
            </div>
            ...
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              ...
              <div className="text-[10px] text-purple-300 flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3" /> Form WHT-01 Auto-Generated
              </div>
            </div>

            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="text-xs text-slate-400">Qatar Financial Centre (QFC) Status</div>
              <div className="text-sm font-bold text-emerald-400">Onshore Mainland Registered</div>
              <div className="text-[10px] text-slate-400">Standard QFC/Mainland Tax Rules Active</div>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="bg-slate-900 rounded-2xl border border-teal-500/30 p-6 space-y-5">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-4 border-b border-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-bold text-white flex items-center gap-2">
                  UAE FTA EmaraTax (VAT Return 201 & Corporate Tax)
                  <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-300 text-[10px] rounded font-mono font-bold">
                    EMARATAX CONNECTED
                  </span>
                </h2>
            ...
            <div className="text-right text-xs font-mono text-slate-400">
              <span className="text-teal-400 font-bold">TRN: 100294819200003</span> • EmaraTax Ref: FTA-DXB-2026-440192
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="text-xs text-slate-400">Mainland Corporate Tax (CT)</div>
              <div className="text-sm font-bold text-white">9% above AED 375,000 Threshold</div>
              <div className="text-[10px] text-emerald-400 flex items-center gap-1">
                <CheckCircle2 className="w-3 h-3" /> Exemption applied to initial AED 375k
              </div>
            </div>

            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="text-xs text-slate-400">Qualifying Free Zone Person (QFZP)</div>
              <div className="text-sm font-bold text-teal-400">0% on Qualifying Income</div>
              <div className="text-[10px] text-slate-400">Ministerial Decision No. 139/2023 Rules</div>
            </div>

            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-2">
              <div className="text-xs text-slate-400">VAT 201 Periodic Filing</div>
              <div className="text-sm font-bold text-white">5.0% Standard Rated Supply</div>
              <div className="text-[10px] text-indigo-300">Reverse Charge & Exports Segregated</div>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-slate-900 rounded-2xl border border-slate-800 shadow-xl p-6 space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-extrabold uppercase tracking-wider text-slate-300">
              Statutory Tax Component Breakdown & Ledger Postings
            </h3>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-slate-300">
              <thead className="bg-slate-950 text-slate-400 font-mono text-[10px] uppercase border-b border-slate-800">
                <tr>
                  <th className="p-3">Tax Component / Schedule</th>
                  <th className="p-3 text-right">Taxable Base Amount</th>
                  <th className="p-3 text-right">Gross Output Tax / Provision</th>
                  <th className="p-3 text-right">Input Tax Credit / Deduction</th>
        ...
        <div className="p-5 bg-slate-950/80 rounded-2xl border border-slate-800 space-y-3">
          <div className="flex items-center gap-2 text-indigo-400 font-semibold text-xs">
            ...
            <span>Statutory Disclosures & Regulatory Audit Schedule</span>
          </div>
        ...
        <div className="p-4 bg-indigo-500/10 border border-indigo-500/20 rounded-xl flex items-center justify-between text-xs text-indigo-300">
          <span>
            💡 <strong>Multi-Jurisdiction Compliance Engine:</strong> Switch between entities in the top header to inspect localized rules:
            <strong className="text-white"> Saudi Arabia (ZATCA FATOORA Phase 2)</strong>,
            <strong className="text-white"> Qatar (GTA Dhareeba)</strong>,
            <strong className="text-white"> UAE (FTA EmaraTax)</strong>,
            <strong className="text-white"> India (GST Act 2017)</strong>,
            <strong className="text-white"> EU (IFRS & Cross-Border VAT)</strong>, or
            <strong className="text-white"> US (GAAP ASC 606)</strong>.
          </span>
        </div>
