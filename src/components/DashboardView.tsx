  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs text-slate-400 font-mono">
              Country: {activeTenant.country} | Standard: {activeTenant.pluginId.toUpperCase()}
            </span>
          </div>
          <h1 className="text-2xl font-bold text-white tracking-tight">
            {activeTenant.name} Accounting Hub
          </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-sm relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Total Assets</span>
          ...
          <div className="flex items-center gap-1 text-[11px] text-emerald-400 mt-2 font-medium">
            ...
            <span>Assets Verified Balanced</span>
          </div>
        </div>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Operating Revenue</span>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Net Profit / Margin</span>
          ...
          <div className="flex items-center gap-1 text-[11px] text-indigo-400 mt-2 font-medium">
            <span>{incomeStatement.grossMarginPercentage}% Gross Margin</span>
          </div>
        </div>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Double-Entry Check</span>
          ...
          <p className="text-lg font-bold text-white mt-3 tracking-tight">
            {balanceSheet.isBalanced ? 'DEBITS = CREDITS' : 'IMBALANCE ALERT'}
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-sm font-semibold text-white">Financial Growth Trajectory</h3>
              <p className="text-xs text-slate-400">Revenue vs Operating Expense trend</p>
            </div>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Bar dataKey="expense" name="Expense" fill="#334155" radius={[6, 6, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-sm flex flex-col">
          ...
          <p className="text-xs text-slate-400 mb-4">Balance breakdown across top asset accounts</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-white">System Security & Scope Audit Log</h3>
            <button
